...
// FullViewModal and useChromeInsets used to live here - both extracted to
// FullViewModal.tsx once PresetFilterModal needed the exact same modal a
// second time (imported at the top of this file instead).
